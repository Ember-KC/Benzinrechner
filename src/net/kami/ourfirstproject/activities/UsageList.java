...
import net.kami.ourfirstproject.imports.UsageListImporter;
import net.kami.ourfirstproject.utils.filechooser.FileChooser;
...
public class UsageList extends ListActivity {
    ...
    // TODO: mehrere Eintr�ge auf einmal l�schen k�nnen (neue Activity).
    //
    // Aktueller Stand 31.03.:
    // Der Haken in der Action Bar muss ausgeblendet bzw. mit sinnvoller
    // Funktionalit�t versehen werden
    // Au�erdem ist eine Checkbox zuviel in der Liste, die muss weg :)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if ((requestCode == FILE_CHOOSER) && (resultCode == -1)) {
            ...
            UsageListImporter.importUsageList(this, fileSelected);
        }
    }
}